...
![App Lab 中的 AI 模型训练入口](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/01_AppLab_AI%E6%A8%A1%E5%9E%8B%E8%AE%AD%E7%BB%83%E5%85%A5%E5%8F%A3.png)
...
![Edge Impulse 项目列表](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/02_EdgeImpulse%E9%A1%B9%E7%9B%AE%E5%88%97%E8%A1%A8.png)

随后我创建新的 Edge Impulse 项目。项目类型选择 `Personal`，可见性选择 `Private`，这样可以保证当前训练数据和模型只作为个人实验项目使用。

![创建个人 Edge Impulse 项目](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/03_EdgeImpulse%E5%88%9B%E5%BB%BA%E4%B8%AA%E4%BA%BA%E9%A1%B9%E7%9B%AE.png)

项目创建完成后，Edge Impulse 自动进入名为 `chicky` 的项目首页。

![小白鸡项目创建完成](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/04_%E5%B0%8F%E7%99%BD%E9%B8%A1%E9%A1%B9%E7%9B%AE%E5%88%9B%E5%BB%BA%E5%AE%8C%E6%88%90.png)

在正式采集和训练前，需要先配置目标设备。这里选择 `Arduino UNO Q (Qualcomm QRB2210)`，这样 Edge Impulse 后续会按照 UNO Q 的处理器、内存和部署环境估算模型性能，并生成适合板端运行的模型。

![选择 Arduino UNO Q 作为目标设备](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/05_%E9%80%89%E6%8B%A9Arduino_UNO_Q%E7%9B%AE%E6%A0%87%E8%AE%BE%E5%A4%87.png)
...
![选择数据采集方式](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/06_%E9%80%89%E6%8B%A9%E6%95%B0%E6%8D%AE%E9%87%87%E9%9B%86%E6%96%B9%E5%BC%8F.png)

我这里使用手机作为采集设备。手机连接成功后，Edge Impulse 会把手机当成一个临时数据源，用摄像头拍摄图片并上传到项目数据集中。

![手机采集设备连接成功](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/07_%E6%89%8B%E6%9C%BA%E9%87%87%E9%9B%86%E8%AE%BE%E5%A4%87%E8%BF%9E%E6%8E%A5%E6%88%90%E5%8A%9F.png)

由于本项目要在画面中框出小白鸡的位置，而不是只判断整张图片是否包含小白鸡，所以我选择的是目标检测项目。Edge Impulse 会询问是否正在构建 object detection project，这里选择 `Yes`。

![启用目标检测采集模式](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/08_%E5%90%AF%E7%94%A8%E7%9B%AE%E6%A0%87%E6%A3%80%E6%B5%8B%E9%87%87%E9%9B%86%E6%A8%A1%E5%BC%8F.png)
...
![采集首批小白鸡样本](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/09_%E9%87%87%E9%9B%86%E9%A6%96%E6%89%B9%E5%B0%8F%E7%99%BD%E9%B8%A1%E6%A0%B7%E6%9C%AC.png)

继续采集后，数据数量逐步增加。为了让模型不要只记住一种背景或一种角度，我在采集时让小白鸡出现在不同位置、不同距离和不同背景中，例如桌面、键盘、鼠标垫附近等。

![累计采集小白鸡样本](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/10_%E7%B4%AF%E8%AE%A1%E9%87%87%E9%9B%86%E5%B0%8F%E7%99%BD%E9%B8%A1%E6%A0%B7%E6%9C%AC.png)

采集完成后，下一步是标注。目标检测数据并不是只写一个类别名，还要在每张图上框出目标所在区域。下图中可以看到左侧是样本列表，右侧是当前样本图像预览。

![样本标注列表与图像预览](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/11_%E6%A0%B7%E6%9C%AC%E6%A0%87%E6%B3%A8%E5%88%97%E8%A1%A8%E4%B8%8E%E5%9B%BE%E5%83%8F%E9%A2%84%E8%A7%88.png)

在单张图像中，我用矩形框包住小白鸡主体，并把这个框标注为 `chicky`。

![绘制小白鸡检测框并标注](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/12_%E7%BB%98%E5%88%B6%E5%B0%8F%E7%99%BD%E9%B8%A1%E6%A3%80%E6%B5%8B%E6%A1%86%E5%B9%B6%E6%A0%87%E6%B3%A8.png)
...
![样本完成 chicky 标签标注](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/13_%E6%A0%B7%E6%9C%AC%E5%AE%8C%E6%88%90chicky%E6%A0%87%E7%AD%BE%E6%A0%87%E6%B3%A8.png)

最终数据集共采集了 180 张图片，并按照 83% / 17% 划分为训练集和测试集：训练集 149 张，测试集 31 张。

![数据集 180 张与训练测试划分](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/14_%E6%95%B0%E6%8D%AE%E9%9B%86180%E5%BC%A0%E4%B8%8E%E8%AE%AD%E7%BB%83%E6%B5%8B%E8%AF%95%E5%88%92%E5%88%86.png)
...
![创建 Impulse 并设置图像参数](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/15_%E5%88%9B%E5%BB%BAImpulse%E5%B9%B6%E8%AE%BE%E7%BD%AE%E5%9B%BE%E5%83%8F%E5%8F%82%E6%95%B0.png)
...
![设置 RGB 图像预处理参数](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/16_%E8%AE%BE%E7%BD%AERGB%E5%9B%BE%E5%83%8F%E9%A2%84%E5%A4%84%E7%90%86%E5%8F%82%E6%95%B0.png)

RGB 保留了颜色信息。虽然小白鸡主体偏白，看起来颜色特征并不复杂，但背景中有桌面、键盘、鼠标垫等不同颜色，RGB 输入可以让模型更好地区分目标和环境。若改成灰度，计算量可能降低，但也会丢失一部分有用的颜色线索。

保存参数后，开始生成特征。

![生成训练特征作业](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/17_%E7%94%9F%E6%88%90%E8%AE%AD%E7%BB%83%E7%89%B9%E5%BE%81%E4%BD%9C%E4%B8%9A.png)

特征生成完成后，Edge Impulse 显示一共创建了 149 个窗口，对应训练集中的 149 个目标样本。右侧的特征可视化图可以帮助观察样本在特征空间中的分布。

![特征生成结果与设备资源预估](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/18_%E7%89%B9%E5%BE%81%E7%94%9F%E6%88%90%E7%BB%93%E6%9E%9C%E4%B8%8E%E8%AE%BE%E5%A4%87%E8%B5%84%E6%BA%90%E9%A2%84%E4%BC%B0.png)
...
![选择 MobileNetV2 SSD 目标检测模型](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/19_%E9%80%89%E6%8B%A9MobileNetV2_SSD%E7%9B%AE%E6%A0%87%E6%A3%80%E6%B5%8B%E6%A8%A1%E5%9E%8B.png)
...
![配置神经网络训练参数](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/20_%E9%85%8D%E7%BD%AE%E7%A5%9E%E7%BB%8F%E7%BD%91%E7%BB%9C%E8%AE%AD%E7%BB%83%E5%8F%82%E6%95%B0.png)
...
![模型训练过程输出](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/21_%E6%A8%A1%E5%9E%8B%E8%AE%AD%E7%BB%83%E8%BF%87%E7%A8%8B%E8%BE%93%E5%87%BA.png)

训练完成后，验证集结果显示 `MAP@50` 达到 0.98。

![验证集训练结果与 MAP 指标](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/22_%E9%AA%8C%E8%AF%81%E9%9B%86%E8%AE%AD%E7%BB%83%E7%BB%93%E6%9E%9C%E4%B8%8EMAP%E6%8C%87%E6%A0%87.png)
...
![int8 量化模型资源与指标](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/23_int8%E9%87%8F%E5%8C%96%E6%A8%A1%E5%9E%8B%E8%B5%84%E6%BA%90%E4%B8%8E%E6%8C%87%E6%A0%87.png)
...
![classification loss 训练曲线](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/24_classification_loss%E8%AE%AD%E7%BB%83%E6%9B%B2%E7%BA%BF.png)

`classification_loss` 关注模型是否把目标判断为正确类别。因为本项目只有一个类别 `chicky`，分类任务相对简单，曲线在前几轮快速下降，说明模型很快学会了小白鸡的类别特征。

![localization loss 训练曲线](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/25_localization_loss%E8%AE%AD%E7%BB%83%E6%9B%B2%E7%BA%BF.png)
...
![total loss 训练曲线](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/26_total_loss%E8%AE%AD%E7%BB%83%E6%9B%B2%E7%BA%BF.png)
...
![模型测试作业运行](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/27_%E6%A8%A1%E5%9E%8B%E6%B5%8B%E8%AF%95%E4%BD%9C%E4%B8%9A%E8%BF%90%E8%A1%8C.png)

测试作业完成后，测试集上的 `MAP@50` 达到 1.00。

![测试集 MAP50 结果](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/28_%E6%B5%8B%E8%AF%95%E9%9B%86MAP50%E7%BB%93%E6%9E%9C.png)
...
![测试集特征分布可视化](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/29_%E6%B5%8B%E8%AF%95%E9%9B%86%E7%89%B9%E5%BE%81%E5%88%86%E5%B8%83%E5%8F%AF%E8%A7%86%E5%8C%96.png)
...
![App Lab 安装自定义模型](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/30_AppLab%E5%AE%89%E8%A3%85%E8%87%AA%E5%AE%9A%E4%B9%89%E6%A8%A1%E5%9E%8B.png)

安装完成后，模型状态变为 `Installed`，并且可以在 Brick 配置中被选中。

![App Lab 模型安装完成](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/31_AppLab%E6%A8%A1%E5%9E%8B%E5%AE%89%E8%A3%85%E5%AE%8C%E6%88%90.png)
...
![小白鸡识别效果一](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/32_%E5%B0%8F%E7%99%BD%E9%B8%A1%E8%AF%86%E5%88%AB%E6%95%88%E6%9E%9C%E4%B8%80.jpg)

第二张图中，小白鸡被旋转到不同角度，模型仍然识别为 `chicky (0.92)`。

![小白鸡识别效果二](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/33_%E5%B0%8F%E7%99%BD%E9%B8%A1%E8%AF%86%E5%88%AB%E6%95%88%E6%9E%9C%E4%BA%8C.jpg)

第三张图中，小白鸡位于较暗背景和鼠标垫附近，模型输出 `chicky (0.89)`，置信度略低但仍然识别正确。

![小白鸡识别效果三](https://raw.githubusercontent.com/sysuwilliam/arduino-UNO-Q-4GB/main/%E5%BC%80%E5%8F%91%E6%8A%A5%E5%91%8A/picture7/34_%E5%B0%8F%E7%99%BD%E9%B8%A1%E8%AF%86%E5%88%AB%E6%95%88%E6%9E%9C%E4%B8%89.jpg)
